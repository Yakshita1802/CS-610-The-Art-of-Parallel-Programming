...
typedef float arr[p_arr+1][p_arr+1]; 
arr a[p_arr_size][p_arr_size], b[p_arr_size][p_arr_size], c[p_arr_size][p_arr_size]; 
arr stream One[p_arr_size][p_arr_size], stream Two[p_arr_size][p_arr_size]; 
int x,y; 

void my_func(int i, int j, 
       value arr var_A, value arr var_B, 
	   arr var_C) { 
  int x,y,k,iter,u,l; 
  arr myC = {0}; 
